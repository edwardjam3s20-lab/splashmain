...
// Org (SaaS multi-tenant) subscription plans — separate table from both
// PLAN_PRICES and OPERATOR_PLAN_PRICES because an org's paying entity is
// the organization itself (see applyPaystackPayment's 'org' branch),
// billed once per org regardless of staff count, not per-user or
// per-car. Single flat plan for now, same shape as OPERATOR_PLAN_PRICES.
export const ORG_PLAN_PRICES = {
  org_monthly: { name: 'Org Monthly', price: 2000 },
}
