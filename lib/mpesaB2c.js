...
export async function initiateB2CPayment({
  ...
  console.log('[B2C] env:', env('MPESA_ENV', 'sandbox'), '| shortcode:', shortcode)
  console.log('[B2C] payload (no cred):', JSON.stringify({ ...payload, SecurityCredential: '[REDACTED]', InitiatorName: '[REDACTED]' }))
  ...
  console.log(
    ...
    res.status,
    '| body:',
    JSON.stringify({ ...data, ConversationID: '[REDACTED]', OriginatorConversationID: '[REDACTED]' })
  )
